...
ggsave(file.path("..", "output", "real_data.png"), width = 4.5, height = 3)
```
...
summary(m_rt)
```
RT decreases from session 1 to session 2, and from session 2 to session 3.
...
ggsave(file.path("..", "output", "param_recov_real_dist.png"), width = 9, height = 5)
```
...
ggsave(file.path("..", "output", "param_infer_real_values.png"), width = 9, height = 3)
```
