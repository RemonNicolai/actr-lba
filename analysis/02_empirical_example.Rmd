...
Not that some of these model fits (sigma[F] and F) have singularity warnings, meaning that we cannot really draw any meaningful conclusions from these fits.
...
Not that here too, some of the model fits (A, d, and d - A/2) have singularity warnings, meaning that we cannot really draw any meaningful conclusions from these fits.
